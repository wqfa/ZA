...
async def iq(iqthonevent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "Welcome to VebThon 𓃠"
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/05697d477614d1975cbef.mp4"
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ فـيبثون - VebThon ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"⚘︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس فـيبثون @VebThon :**\n\n{o}")
...
async def update_owner(event):
    if event.sender_id == 1226408155:
        ...
        await update_msg.edit("""⚘︙ جـاري تـحديث فـيبثون (8.2)
    ⌚ انتضر من 5 الى 10 دقائق""")
        try:
            ulist = get_collectionlist_items()
            for i in ulist:
...
قناة الكلايش  : @T9_10
قناه شروحات الاوامر  : @VebThon
قناه المتغيرات او الفارات : @C45CS""")
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**⚘︙  📑 يرجى متابع قناه الفارات تجدها هنا : @C45CS")
...
———————×———————**
CH : @VebThon
⚘︙ يوجد شرح مفصل عن الامر هنا : https://t.me/T9_10
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/T9_10
شرح الأوامر : ( @VebThon ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/T9_10 
قناه السورس : ( @VebThon ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/T9_10
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/T9_10  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/T9_10  ⦒
""")
