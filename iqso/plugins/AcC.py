...
from iqso import BOTLOG_CHATID
from ..sql_helper.globals import addgvar, delgvar, gvarstatus
from ..Config import Config
...
iqthonfont = gvarstatus("DEFAULT_PIC") or "iqso/sql_helper/IQTHONIMOGE.ttf"
FONT_FILE_TO_USE = "/usr/share/fonts/truetype/dejavu/DejaVuSansMono.ttf"
autopic_path = os.path.join(os.getcwd(), "iqso", "original_pic.png")
digitalpic_path = os.path.join(os.getcwd(), "iqso", "digital_pic.png")
autophoto_path = os.path.join(os.getcwd(), "iqso", "photo_pfp.png")
...
@iqthon.on(events.NewMessage(outgoing=True, pattern=r'.تكرار صوره ?(.*)'))
async def RepeatImage(event):
    chat = await event.get_chat()
    MESSAGE = ((event.message.message).replace(".تكرار صوره", "")).split(" ")
    ...
    try:
        ...
        os_failed = await event.edit(f'**بالرجاء استخدام الصيفة التالية : .تكرار صوره 10 + مع الرد على الصوره**')



 # فرخ لاتخمط لاالفكرة ولا الكود يافرخ
@iqthon.on(events.NewMessage(outgoing=True, pattern=r'.تكرار متحركه ?(.*)'))
async def RepeatImage(event):
    chat = await event.get_chat()
    MESSAGE = ((event.message.message).replace(".تكرار متحركه", "")).split(" ")
    ...
    try:
        ...
        os_failed = await event.edit(f'**بالرجاء استخدام الصيفة التالية : .تكرار متحركه 10 + مع الرد على متحركه**')

 # فرخ لاتخمط لاالفكرة ولا الكود يافرخ
@iqthon.on(events.NewMessage(outgoing=True, pattern=r'.تكرار فيديو ?(.*)'))
async def RepeatImage(event):
    chat = await event.get_chat()
    MESSAGE = ((event.message.message).replace(".تكرار فيديو", "")).split(" ")
    ...
    try:
        ...
        os_failed = await event.edit(f'**بالرجاء استخدام الصيفة التالية : .تكرار فيديو 10 + مع الرد على فيديو**')



 # فرخ لاتخمط لاالفكرة ولا الكود يافرخ
@iqthon.on(events.NewMessage(outgoing=True, pattern=r'.تكرار ملصق ?(.*)'))
async def RepeatImage(event):
    chat = await event.get_chat()
    MESSAGE = ((event.message.message).replace(".تكرار ملصق", "")).split(" ")
    ...
    try:
        ...
        os_failed = await event.edit(f'**بالرجاء استخدام الصيفة التالية : .تكرار ملصق 10 + مع الرد على ملصق**')

 # فرخ لاتخمط لاالفكرة ولا الكود يافرخ
@iqthon.on(events.NewMessage(outgoing=True, pattern=r'.تكرار صوت ?(.*)'))
async def RepeatImage(event):
    chat = await event.get_chat()
    MESSAGE = ((event.message.message).replace(".تكرار صوت", "")).split(" ")
